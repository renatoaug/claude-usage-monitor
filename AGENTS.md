...
- Compact and pet-only moods follow activity across connected providers, independently of the selected usage tab. Logos identify the workers; simultaneous work uses a stable generic working animation. No active sources means rest, with quota warnings still shown in the meters. Stale activity and disconnected sources are ignored.
